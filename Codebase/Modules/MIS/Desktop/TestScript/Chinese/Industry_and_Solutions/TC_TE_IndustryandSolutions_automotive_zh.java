...
public class TC_TE_IndustryandSolutions_automotive_zh extends BaseTest {
	...
	private String dataFileName = "Industries and solutions(automotive)_zh.xls";
	private String mstrTC_Name = "TC_TE_IndustryandSolutions_automative_zh";
...
//******************************************* Test Case Starts ***************************************************
	...
	//  ************ Click on Industry and Solution ***********
		...
		public void clickOnIndustryAndSolution(){
			...
			if(operationFlag){
				...
				test.log(LogStatus.INFO, "Industry And Solution Tab is clicked");
			}	
				
			else
				Reporter.log("Industry And Solution not Clicked");
				test.log(LogStatus.INFO, "Industry And Solution Tab is NOT clicked");
			//Assert.assertEquals(operationFlag, true);
		}


	//  ************ Click on Automative tab ***********
		...
		public void clickOnAutomotiveTab(){
			...
			if(operationFlag)
			{
				...
				test.log(LogStatus.INFO, "Automotive Tab is clicked");

			}else

			{//Reporter.log("Automotive Tab not Clicked");
			test.log(LogStatus.INFO, "Automotive Tab is NOT clicked");

			}
			//Assert.assertEquals(operationFlag, true);
		}

	//  ************ Click on Automative product tab ***********
	...
	//  ************ Click on ProdCategory_AutomotiveTruckBusOffRoad  ***********
		...
		public void clickOnProdCategory_AutomotiveTruckBusOffRoad(){
...

			{
				...
				test.log(LogStatus.INFO, "Product category option Automotive, Truck, Bus & Off-Road Connectors link is clicked");
			}
			else
			{
				Reporter.log("Product category option Automotive, Truck, Bus & Off-Road Connectors link is not Clicked");
				test.log(LogStatus.INFO, "Product category option Automotive, Truck, Bus & Off-Road Connectors link is NOT clicked");
			}
			//Assert.assertEquals(operationFlag, true);
		}
	...
	//  ************ Click on ProdCategory_AutomotiveTruckBusOffRoad  ***********
		...
		public void clickOnAutomotiveProductTabOptions(){
...

			{
				...
				test.log(LogStatus.INFO, "View All Automotive, Truck, Bus & Off-Road Connectors  link is clicked");
			}
			else
			{
				//Reporter.log("View All Automotive, Truck, Bus & Off-Road Connectors link not Clicked");
				test.log(LogStatus.INFO, "View All Automotive, Truck, Bus & Off-Road Connectors  link is NOT clicked");
			}
			//Assert.assertEquals(operationFlag, true);
		}
	...
	//  ************ Click on Results ***********
		...
		public void clickOnResults(){
			...
			test.log(LogStatus.INFO, "Expected Result : " + rowData.get("Results").toString());
			

			if(actualResult.equalsIgnoreCase(expectedResult)){

				//Reporter.log("Result Same");
				test.log(LogStatus.INFO, "Result Same");
				
			} else {
				//Reporter.log("Result NOT Same");
				test.log(LogStatus.INFO, "Result NOT Same");
			}

		}

	//  ************ Click on Industries Facet  ***********
		...
		public void clickOnIndustriesFacet(){
...

			{
				...
				test.log(LogStatus.INFO, "Industry Facet Tab is clicked");
...

			{
				...
				test.log(LogStatus.INFO, "Industry Facet Tab is NOT clicked");
			}
			//Assert.assertEquals(operationFlag, true);
		}
	...
	//  ************ Click on Applications Facet  ***********
		...
		public void clickOnApplicationsFacet(){
			...
			if(operationFlag)
			{
				...
				test.log(LogStatus.INFO, "Application Facet Tab is clicked");
			}
			else

			{
				Reporter.log("Application Facet Tab not Clicked");
				test.log(LogStatus.INFO, "Application Facet Tab is NOT clicked");
			}
			//Assert.assertEquals(operationFlag, true);
		}

	//  ************ Click on ProductAndFamiliesFacet   ***********
		...
		public void clickOnProductAndFamiliesFacet(){
...

			{
				...
				test.log(LogStatus.INFO, "Product And Family Tab is clicked");
			}
			else

			{
				//Reporter.log("Product And Family  Tab not Clicked");
				test.log(LogStatus.INFO, "Product And Family  Tab not Clicked");
			}
			//Assert.assertEquals(operationFlag, true);
		}
	...
	//  ************ Click on Standards Facet   ***********
		...
		public void clickOnStandardsFacets(){
...

			{
				...
				test.log(LogStatus.INFO, "Standard Tab is clicked");
			}
			else

			{
				//Reporter.log("Standard Tab not Clicked");
				test.log(LogStatus.INFO, "Standard Tab not Clicked");
