...
public class TC_TE_IndustriesAndSolutions_Aerospace_en extends BaseTest {
	...
	private String mstrTC_Name = "TC_TE_IndustriesAndSolutions_Aerospace_en";
	...
	// ******************************************* Test Case Starts
	// ***************************************************
	@Parameters({ "device_new", "browserName", "browser_version", "os", "os_version", "resolution", "ip", "port_no",
			"proxyHost", "proxyPort" })
	@BeforeClass
