...
public class TC_TE_Industry_Solution_03_ja {
	...
	//-------------------Local variable decleration---------------------//
			...
			private String dataFileName = "TC_TE_Industries_And_Solution_03_ja.xls";
			private String mstrTC_Name = "TC_TE_Industry_Solution_03_ja";
			...
			public void clickOnViewAll(){
				...
				operationFlag = globalFunction.checkIfElementEnabled(pnpPage.viewAll_PictureLink);
			...
			*/
			 ...
			 public void clickOnProductFamiliesFacet(){
				   ...
				   if(operationFlag){
						Reporter.log("ProductFamily Facet is Clicked");
				  } else {
