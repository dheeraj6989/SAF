...
public class TC_TE_IndustriesAndSolutions_Aerospace_de extends BaseTest {
	...
	private String dataFileName = "TC_TE_IndustriesAndSolutions_Aerospace_de.xls";
	private String mstrTC_Name = "TC_TE_IndustriesAndSolutions_Aerospace_de";
	...
	//******************************************* Test Case Starts ***************************************************
		...
		@BeforeClass
		public void script(String device_new, String browser, String browser_version, String os, String os_version,
				String resolution, String ip, String port, String proxyHost, String proxyPort, ITestContext testContext) {
		...
		public void verifyPrimaryImageDisplayed(String Keyword, String Index, String Results, String Facets,
			...
			*/
			...
			homePage.closePopUp();
			globalFunction.scroll_Horizontal(-1000);
